        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div class="bg-white p-3 shadow rounded-lg md:col-span-2">
                <form x-data="{
                    ...
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Profiel informatie</h2>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <x-input
                            ...
                            class="w-full focus:border-green-600 focus:ring-green-600 border-gray-300 rounded"
                        />
                        <x-input
                            type="text"
                            name="last_name"
                    ...
                    <h2 class="text-xl mt-6 font-semibold mb-2">Factuur Adres</h2>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                            <x-input
                                type="text"
                    ...
                    <div class="flex justify-between mt-6 mb-2">
                        <h2 class="text-xl font-semibold">Bezorg adres</h2>
            ...
            <div class="bg-white p-3 shadow rounded-lg">
                <form action="{{route('profile_password.update')}}" method="post">
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Update Wachtwoord</h2>
                    <div class="mb-3">
                        <x-input
                            type="password"
                            name="old_password"
