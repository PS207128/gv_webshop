...
<button @click="emit('toggle-sidebar')" class="flex items-center justify-center w-8 h-8 text-gray-700 hover:bg-black/10">
  <Bars3Icon class="w-6"/>
</button>
<div>
  ...
  <Menu as="div" class="relative inline-block text-left">
    <div>
      <MenuButton class="flex items-center">
        <img src="https://randomuser.me/api/portraits/men/64.jpg" class="rounded-full w-8 mr-2">
